...
export DATABASE="/gpfs0/bioinfo/users/obayomi/databases/SILVA_128_QIIME_release/rep_set/rep_set_16S_only/97/97_otus_16S.fasta"
export DIR="/gpfs0/bioinfo/users/obayomi/hinuman_analysis/q1_16S_illumina/04.chimera_check/"
export SPLIT_FASTA="${DIR}/split_samples/"
export SEQS_FNA="/gpfs0/bioinfo/users/obayomi/hinuman_analysis/q1_16S_illumina/03.demultiplexed/seqs.fna"
